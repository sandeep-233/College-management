...
import { getPYQ } from '../../../services/operations/studentFeaturesAPI';
...
//   console.log("form data: ", formData);
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const res = await getPYQ(subject)
    ...
    <div className="bg-white h-[96%] w-[70%] ml-4 rounded-xl mr-7">
          <div className="bg-gray-200 h-screen  p-4">
            <div className="bg-white rounded-lg p-4 mr-5 ">
                <h1 className="text-2xl mb-5 p-5 border-b-2 ">Previous Year Questions</h1>
                  ...
                  <div className='w-[60%] flex gap-4 flex-wrap justify-start items-center m-auto'>
                        {
                            pyqDetails.map((pyq) => (
                                ...
                                >
                                    ...
                                    >
                                        {pyq?.heading}
                                        <span className=''>{pyq?.attachmentDate}</span>
                                    </a>
                                </div>
                            ))
                        }
